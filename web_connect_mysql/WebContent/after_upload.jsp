...
connection =DriverManager.getConnection(test,userName,userPasswd);  
		...
		String paranB2 = request.getParameter("paranA2"); 
	    ...
	    //out.print(C_NUM);
	   // out.print(T_NUM);
	    String CC_NUM = request.getParameter("paranB2");
	    String TT_NUM  = request.getParameter("paranB3");
  ...
  %>
    ...
    <tr>
        ...
        %>       
         ...
         <p><a href="open_course-stu-insert.jsp?paranB2=<%=CC_NUM%>&&paranB3=<%=TT_NUM%>&&paranB4=<%=S_SCORE%>&&paranB5=<%=S_C_CREDIT%>">增加学生</a></p>
