...
<% 
    ...
    String query = "SELECT * FROM open_course where C_NUM='"+C_NUM+"'and T_NUM='"+T_NUM+"'and C_TERM='"+C_TERM+"';"; 
   ...
   <%
	   ...
	   if(result.next()){
        //   String sql="update open_course set C_NUM='"+C_NUM+"', T_NUM='"+T_NUM+"',C_TERM='"+C_TERM+"' where C_NUM= '"+C_NUM+"'";
         ///  statement.executeUpdate(sql);
           //out.println("成功更新开课表:课程号为"+C_NUM+"<br>");
