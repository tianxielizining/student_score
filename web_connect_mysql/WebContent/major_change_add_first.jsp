...
try{
	...
	String departmentnum=request.getParameter("department");	
    	conn.close();%>
    	 <form action= "major_change_add.jsp" method="post" onsubmit="return check();">
        <table align="center" width="450">
            ...
            <tr>
                ...
                <td><input type="text" id="a1" name="M_NUM"  value="<%=departmentnum%>" ></input></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input type="text" id="a3" name="M_NAME" placeholder="不可以为空" ></input></td>
            </tr>
            <tr>
                <td align="right">本科毕业所需学分：</td>
                <td>
                <!--  <input type="text" id="a4" name="UNDER_CREDIT" placeholder="不可以为空" ></input>-->
               <input type="text" name="UNDER_CREDIT" pattern="[0-9]{1,3}" title="请输入数字" /> 
                </td>
            </tr>
            <tr>
                <td align="right">研究生毕业所需学分：</td>
                <td>
                <!--  <input type="text" id="a5" name="POST_CREDIT" placeholder="不可以为空" ></input>-->
                 <input type="text" name="POST_CREDIT" pattern="[0-9]{1,3}" title="请输入数字" /> 
                </td>
            </tr>
            <tr>
                <td align="right">博士生毕业所需学分：</td>
                <td>
              <!--   <input type="text" id="a6" name="DOCTOR_CREDIT" placeholder="不可以为空" ></input> -->
                <input type="text" name="DOCTOR_CREDIT" pattern="[0-9]{1,3}" title="请输入数字" /> 
                </td>
            </tr>
            <tr>
                <td align="center" colspan="2">
